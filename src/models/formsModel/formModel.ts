...
interface DynamicForm {
  formName: string;
  fields: (TextField | TextAreaField | RadioField | CheckboxField<any> | DateField)[];
}
...
const TextFieldModel = mongoose.model<TextField & Document>('TextField', textFieldSchema);
const TextAreaFieldModel = mongoose.model<TextAreaField & Document>('TextAreaField', textAreaFieldSchema);
const EmailFieldModel = mongoose.model<EmailField & Document>('EmailField', emailFieldSchema);
const PasswordFieldModel = mongoose.model<PasswordField & Document>('PasswordField', passwordFieldSchema);
const RadioFieldModel = mongoose.model<RadioField & Document>('RadioField', radioFieldSchema);
const CheckboxFieldModel = mongoose.model<CheckboxField<any> & Document>('CheckboxField', checkboxFieldSchema);
const DateFieldModel = mongoose.model<DateField & Document>('DateField', dateFieldSchema);
const DynamicFormModel = mongoose.model<DynamicForm & Document>('DynamicForm', dynamicFormSchema);

export { TextFieldModel, TextAreaFieldModel,EmailFieldModel, PasswordFieldModel, RadioFieldModel, CheckboxFieldModel, DateFieldModel, DynamicFormModel };
